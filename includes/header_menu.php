...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Shopping Secrets</a>
                           ...
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                  <a href="">&nbsp;<b>Men</b></a>
                                   ...
                                   <a href="">&nbsp;<b>Women</b></a>
                                   <a href="productwo.php#ww" class="dropdown-item">Watches</a>
                                   <a href="productwo.php#wc" class="dropdown-item">Clothing</a>
                                   <a href="productwo.php#ws" class="dropdown-item">Shoes</a>
                                   <a href="productwo.php#wa" class="dropdown-item">Accesories</a>
                               </div>
